...
5.  Visualize top 5 enriched motifs for each set of peaks
    ...
    For brevity, only the ‘common’ peak comparisons are shown here. Motif logo plots for the unique uninjured, unique injured, unique WT, and unique MDX sets are available in Supplementary Figure X.
...
![Comparison of the top 5 enriched motifs identified in the paper versus our analysis (UI = Uninjured, I = Injured)](images/enriched_motifs_comparison.png){width="744"}
...
: Comparison of MEME (AME) and HOMER (findMotifsGenome.pl) features and the potential impact.
...
```{r, fig.width=10, fig.height=10, dpi=150 remaining motif logo plots}
