...
4.  Run motif enrichment analysis
    ...
    We performed motif enrichment using MEME’s AME tool (Robert McLeay and Timothy L. Bailey, "Motif Enrichment Analysis: A unified framework and method evaluation", BMC Bioinformatics, 11:165, 2010, <doi:10.1186/1471-2105-11-165>) with its defaults (i.e. `avg` scoring, one‑tailed Fisher’s test, and a shuffled background), rather than HOMER used in the original paper.
